...
Partial Class invoice
    ...
    Protected Sub Page_PreInit(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.PreInit
        ...
        'dt.Columns.Add("ordernumber").DataType = GetType(String)
        ...
        'dt.Columns.Add("PaymentRec").DataType = GetType(String)
    ...
    Protected Sub Gridview1_Sorting(ByVal sender As Object, ByVal e As System.Web.UI.WebControls.GridViewSortEventArgs) Handles Gridview1.Sorting
        ...
        Dim dt As DataTable = ds.Tables("Invoices") 'Session("dt")
    ...
    Protected Function total() As Decimal
        ...
        For i As Integer = 0 To GridView2.Rows.Count - 1
            ...
            End If
        Next
        Dim hours As Integer = Integer.TryParse(txtHours.Text, hours) 'CInt(txtHours.Text)
        Dim discount As Decimal = Decimal.TryParse(txtDiscount.Text, discount) ' CInt(txtDiscount.Text)
        discount = discount / 100
